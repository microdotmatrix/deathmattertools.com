...
interface SurveyListProps {
  surveys: PreNeedSurvey[];
  entryId: string;
  entryName: string;
}

export function SurveyList({ surveys, entryId, entryName }: SurveyListProps) {
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-muted-foreground mt-2">
          Create a pre-need survey to help gather important information about {entryName}.
        </p>
        <div className="mt-6">
          <CreateSurveyDialog entryId={entryId} entryName={entryName} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">Pre-Need Surveys</h3>
        <CreateSurveyDialog entryId={entryId} entryName={entryName} />
      </div>
