/**
 * TODO: Re-enable this cron job when we upgrade to Vercel Pro since Hobby plan does not support
 * cron jobs and its causing deployments to fail.
 */
// For now, we're not cleaning up orphaned uploads to avoid data loss
